...
var t_angle_switch = t_angle_switch_prefab.new([0.1,0,0,0.3,0,0,0,0.8,0,0,0.9])
...
var t_strength_switch = t_strength_switch_prefab.new([0.8,0,0,0.4,0,0,0,0.9,0,0,0.9])
...
func _on_Button_pressed():
	...
	GenotypeManager.new_creature(c_genome.dna, Vector2(150,0))